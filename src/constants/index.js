...
export const resumeLink = "https://drive.google.com/file/d/1ZMFiOw_T0-X1pP1zxlQuFdIUi0QOUyt9/view?usp=sharing";
    ...
    positions: [
      {
        ...
        content: [
          ...
          {
            text: "• Integrated Swagger-based RESTful APIs, ensuring smooth data flow and alignment with client requirements.",
            link: "",
          },
          {
            text: "• Experienced in building deposit management systems through API integration",
            link: "",
          },
        ],
      }
...
export const projects = [
  ...
  },
  {
    ...
    image: "https://i.pinimg.com/736x/18/22/50/182250d691fa645b86cc34d0947273f2.jpg",
    content:
  ...
  },
  {
    ...
    content:
      "All Porsche 911 models with Parallax effect.Modern and Simple",
    stack: [
      {
        id: "icon-1",
        icon: SiNextdotjs,
  ...
  },
  {
    ...
    image: "https://play-lh.googleusercontent.com/9HT3x5ccHcOdhBgLVsNEE6uV9tsCy4GJkoQ8SiJid6xxdhoZnXtyIVhyFEBzoRvAjc4",
    content:
      "Qr-Code Maker with links",
    stack: [
      {
        id: "icon-1",
        icon: SiJquery,
...
export const aboutMe = {
  ...
  intro: "Front End Software Engineer"
}
